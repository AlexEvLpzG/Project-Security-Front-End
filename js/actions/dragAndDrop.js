...
export const dragAndDrop = () => {
    ...
    const buttonSave      = optionDocument.querySelector( '.btn.save' );
    const encryptButton   = optionDocument.querySelector( '.btn.encrypt' )
    ...
    function clearList() {
        ...
        const buttonEmpty = optionDocument.querySelector( '.btn.empty' );
